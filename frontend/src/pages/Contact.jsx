  ...
  return (
    <main className="page-content">
      ...
      <section className="panel highlight-panel">
        <p>
          Available for academic collaboration, research partnerships and
          engineering education workshops. Reach out to discuss curriculum
          design, laboratory training and applied materials research.
        </p>
      </section>
      ...
      <section className="panel contact-page-grid">
        <div className="contact-card-panel">
          <div>
            ...
            <p className="page-intro-text">
              Connect for research supervision, consulting, project
              collaboration and speaking opportunities.
            </p>
          </div>
          ...
          {loading ? (
            ...
            <div className="contact-card-grid">
              ...
              <div className="contact-card">
                <div className="contact-card-title">
                  <span
                    className="contact-card-icon contact-card-icon-location"
                    aria-hidden="true"
                  />
                  Location
                </div>
          ...
          <div className="contact-card-footer">
            <p>
              For the fastest response, include your project brief,
              collaboration topic, or research question in the message form.
            </p>
          </div>
        </div>
        ...
        <div className="contact-form-panel">
          <div>
            ...
            <p className="page-intro-text">
              Use this form to start a conversation. Your message will open in
              your email client so you can review it before sending.
            </p>
          </div>
          ...
          <div className="contact-form">
            ...
            <div className="form-group">
              ...
              <textarea
                ...
                placeholder="Tell me about your research or request"
              />
            </div>
            <div className="contact-form-actions">
              ...
              <p className="contact-form-note">
                This will prepare a mail message with your details. You can

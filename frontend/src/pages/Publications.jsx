...
function Publications() {
  ...
  const categories = [
    {
      ...
      description: "Peer-reviewed journal and conference work.",
    },
    {
      key: "Article",
      title: "Academic Articles",
      description:
        "Technical articles, educational reports, and thought leadership.",
    },
    {
      key: "Patent",
      title: "Patents",
      description: "Filed patents, applied inventions and innovation records.",
    },
  ];
  ...
  return (
    <main className="page-content">
      <SectionHeading
        title="Publications, Articles & Patents"
        eyebrow="Research output"
      />

      <section className="panel highlight-panel">
        <p>
          A strong portfolio of publications, articles and patents highlights
          teaching excellence, materials research, and applied engineering
          innovation.
        </p>
      </section>
